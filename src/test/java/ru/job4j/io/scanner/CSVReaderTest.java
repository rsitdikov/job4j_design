...
public class CSVReaderTest {
    ...
    @Test
    public void whenFirstFilterWrong() throws IOException {
        String data = String.join(
                System.lineSeparator(),
                "name;age;last_name;education",
                "Tom;20;Smith;Bachelor",
    ...
    public void whenAllFiltersWrong() throws IOException {
        String data = String.join(
                System.lineSeparator(),
                "name;age;last_name;education",
                "Tom;20;Smith;Bachelor",
    ...
    @Test
    public void whenFilterOrderWrong() throws IOException {
        String data = String.join(
                System.lineSeparator(),
                "name;age;last_name;education",
                "Tom;20;Smith;Bachelor",
    ...
    @Test (expected = IllegalArgumentException.class)
    public void whenParameterMissing() throws IOException {
        String data = String.join(
                System.lineSeparator(),
                "name;age;last_name;education",
                "Tom;20;Smith;Bachelor",
        ...
        File target = temporaryFolder.newFile("target.csv");
        ArgsName argsName = ArgsName.of(new String[]{
                "-path=" + file.getAbsolutePath(), "-out=" + target.getAbsolutePath(),
                "-filter=surname,account"
        });
        Files.writeString(file.toPath(), data);
        CSVReader.handle(argsName);
